...
global using MessageBox = LoneArenaDmaRadar.UI.Misc.MessageBox;
global using MessageBoxButton = LoneArenaDmaRadar.UI.Misc.MessageBoxButton;
global using MessageBoxImage = LoneArenaDmaRadar.UI.Misc.MessageBoxImage;
global using MessageBoxOptions = LoneArenaDmaRadar.UI.Misc.MessageBoxOptions;
global using MessageBoxResult = LoneArenaDmaRadar.UI.Misc.MessageBoxResult;
global using RateLimiter = LoneArenaDmaRadar.Misc.RateLimiter;
