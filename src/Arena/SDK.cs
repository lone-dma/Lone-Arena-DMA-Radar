namespace SDK
{
    ...
    public readonly partial struct Offsets
    {
        ...
        {
            public const uint Location = 0x98; // String
        }

        public readonly partial struct ClientLocalGameWorld
        {
            public const uint RegisteredPlayers = 0x148; // System.Collections.Generic.List<IPlayer>
            public const uint MainPlayer = 0x1B8; // EFT.Player
            public const uint Grenades = 0x218; // -.\uE42E<Int32, Throwable>
            public const uint IsInRaid = 0x298; // [HUMAN] Bool
        }
